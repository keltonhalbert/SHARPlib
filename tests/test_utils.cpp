...
TEST_CASE("Testing max_value over pressure layer") {
    ...
    CHECK(sharp::max_value(layer1, pres, data, 10) == 10.0);
    CHECK(sharp::max_value(layer2, pres, data, 10) == 10.0);
    CHECK(sharp::max_value(layer3, pres, data, 10) ==  0.0);

    CHECK(sharp::max_value(layer4, pres, data, 10) ==  doctest::Approx(4.80749));
}
...
TEST_CASE("Testing min_value over pressure layer") {
    ...
    CHECK(sharp::min_value(layer4, pres, data, 10) ==  doctest::Approx(-4.80749));
}
...
TEST_CASE("Testing max_value over height layer") {
    ...
    CHECK(sharp::max_value(layer1, hght, data, 10) == 10.0);
    CHECK(sharp::max_value(layer2, hght, data, 10) == 10.0);
    CHECK(sharp::max_value(layer3, hght, data, 10) ==  0.0);

    CHECK(sharp::max_value(layer4, hght, data, 10) ==  7.5);
}
