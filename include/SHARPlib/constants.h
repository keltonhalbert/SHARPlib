...
static constexpr float ZEROCNK =
    273.15f;  // conversion between celsius and kelvin
...
static constexpr float TOL =
    1e-10;  // Floating point tolerance for iterative convergence functions
...
static constexpr float CP_DRYAIR =
    1005.7f;  // specific heat capacity of dry air (J/kg)
static constexpr float CP_VAPOR =
    1870.0f;  // specific heat capacity of water vapor (J/kg) at const pressure
static constexpr float CP_WATER =
    4190.f;  // specific heat capacity of water (J/kg)
static constexpr float CP_ICE =
    2106.0f;                           // specific heat capacity of ice (J/kg)
static constexpr float LV = 2.501e6f;  // Latent heat of vaporization of water
                                       // (J/kg) at triple point temperature
static constexpr float LS = 2.834e6f;  // Latent heat of sublimation of water
...
static constexpr float VAPPRES_REF =
    611.65;  // Reference vapor pressure of water vapor at triple point
             // temperature (Pa)
